...
// ── Üyelik / Mağaza ──
Object.assign(EN, { membership: 'Membership', membership_sub: 'Upgrade for unlimited AI designs, real image generation and more', current_plan: 'Your plan', upgrade: 'Upgrade', select: 'Select', credit_packs: 'Credit Packs', credits: 'credits', payment_soon: 'Payment integration coming soon — selection is saved locally for now.', plan_locked: 'Not available', renew: 'Renew', days_left: 'days left', upgrade_rules: 'You can\'t re-buy your active plan before it expires — only upgrade. Once it expires you can pick any plan (downgrade included). Extra packs are always available.' });
Object.assign(TR, { membership: 'Üyelik', membership_sub: 'Sınırsız AI tasarım, gerçek görsel üretimi ve daha fazlası için yükseltin', current_plan: 'Planınız', upgrade: 'Yükselt', select: 'Seç', credit_packs: 'Kredi Paketleri', credits: 'kredi', payment_soon: 'Ödeme entegrasyonu yakında — şimdilik seçim cihazda saklanıyor.', plan_locked: 'Uygun değil', renew: 'Yenile', days_left: 'gün kaldı', upgrade_rules: 'Aktif paketinizi süresi bitmeden tekrar alamazsınız — yalnızca yükseltebilirsiniz. Süresi dolunca istediğiniz planı seçebilirsiniz (düşürme dahil). Ek paketler her zaman alınabilir.' });
Object.assign(RU, { membership: 'Подписка', membership_sub: 'Безлимитные AI-дизайны и генерация изображений', current_plan: 'Ваш план', upgrade: 'Улучшить', select: 'Выбрать', credit_packs: 'Пакеты кредитов', credits: 'кредитов', payment_soon: 'Оплата скоро — выбор пока сохраняется локально.', plan_locked: 'Недоступно', renew: 'Продлить', days_left: 'дн. осталось', upgrade_rules: 'Нельзя повторно купить активный план до окончания — только улучшение. После окончания можно выбрать любой план (в т.ч. ниже). Доп. пакеты доступны всегда.' });
Object.assign(AR, { membership: 'العضوية', membership_sub: 'ترقية لتصاميم ذكاء غير محدودة وإنشاء صور حقيقية', current_plan: 'خطتك', upgrade: 'ترقية', select: 'اختيار', credit_packs: 'حزم الأرصدة', credits: 'رصيد', payment_soon: 'الدفع قريباً — يُحفظ الاختيار محلياً الآن.', plan_locked: 'غير متاح', renew: 'تجديد', days_left: 'يوم متبقٍ', upgrade_rules: 'لا يمكنك إعادة شراء خطتك النشطة قبل انتهائها — الترقية فقط. بعد انتهائها يمكنك اختيار أي خطة (بما في ذلك الأدنى). الحزم الإضافية متاحة دائماً.' });
