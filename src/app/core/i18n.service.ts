...
const EN: Dict = {
  ...
  studio_tailored: '✨ Tailored to your hand scan', studio_tailored_prompt: 'An elegant, salon-quality nail design tailored to my {shape} nail shape and {tone} undertone, in {color}, {finish}',
...
const TR: Dict = {
  ...
  studio_tailored: '✨ Elinize özel — tarama sonucuna göre', studio_tailored_prompt: '{shape} tırnak şeklime ve {tone} ten tonuma uygun, {color} renkte, {finish}, salon kalitesinde zarif bir tırnak tasarımı',
...
const RU: Dict = {
  ...
  studio_tailored: '✨ Подобрано по результатам сканирования', studio_tailored_prompt: 'Элегантный маникюр салонного качества для моей формы ногтей «{shape}» и {tone} подтона, в оттенке {color}, {finish}',
...
const AR: Dict = {
  ...
  studio_tailored: '✨ مصمم خصيصًا لك حسب فحص يدك', studio_tailored_prompt: 'تصميم أظافر أنيق بجودة الصالون يناسب شكل أظافري {shape} ودرجة لوني {tone}، بلون {color}، {finish}',
...
Object.assign(EN, {
  ...
  choose_shape: 'Nail shape', manual_note: 'Fine-tune any result below — tap to adjust skin tone, undertone, nail structure or shape.', manual_fix: 'Analysis wrong? Fix it', result_undertone: 'Undertone', result_hand: 'Hand',
...
Object.assign(TR, {
  ...
  choose_shape: 'Tırnak şekli', manual_note: 'Sonuçları aşağıdan elle ayarlayabilirsin — ten tonu, alt ton, tırnak yapısı ve şekli.', manual_fix: 'Analiz yanlış mı? Düzelt', result_undertone: 'Alt Ton', result_hand: 'El',
...
// ── AR Deneme ──
Object.assign(EN, { ar_title: 'AR Try-On', ar_capture: 'Capture', ar_color: 'Polish color', ar_close: 'Close', ar_hint: 'Show your hand to the camera', ar_starting: 'Starting camera...', ar_need_credit: 'AR try-on used up. Generate a new nail design to try it on.', ar_generating: 'Generating realistic photo...', ar_make_realistic: 'Make it realistic', ai_gen_failed: 'Could not generate the image. Please try again.' });
Object.assign(TR, { ar_title: 'AR Deneme', ar_capture: 'Fotoğraf', ar_color: 'Oje rengi', ar_close: 'Kapat', ar_hint: 'Elinizi kameraya gösterin', ar_starting: 'Kamera başlatılıyor...', ar_need_credit: 'AR deneme hakkın kullanıldı. Denemek için yeni bir tasarım üret.', ar_generating: 'Gerçekçi fotoğraf oluşturuluyor...', ar_make_realistic: 'Gerçekçi Görsel Oluştur', ai_gen_failed: 'Görsel oluşturulamadı. Lütfen tekrar deneyin.' });
Object.assign(RU, { ar_title: 'AR примерка', ar_capture: 'Снимок', ar_color: 'Цвет лака', ar_close: 'Закрыть', ar_hint: 'Покажите руку камере', ar_starting: 'Запуск камеры...', ar_need_credit: 'AR-примерка использована. Создайте новый дизайн, чтобы примерить.', ar_generating: 'Создание реалистичного фото...', ar_make_realistic: 'Сделать реалистичным', ai_gen_failed: 'Не удалось создать изображение. Попробуйте снова.' });
Object.assign(AR, { ar_title: 'تجربة AR', ar_capture: 'التقاط', ar_color: 'لون الطلاء', ar_close: 'إغلاق', ar_hint: 'أظهري يدك للكاميرا', ar_starting: 'جارٍ تشغيل الكاميرا...', ar_need_credit: 'انتهت تجربة AR. أنشئي تصميمًا جديدًا للتجربة.', ar_generating: 'جارٍ إنشاء صورة واقعية...', ar_make_realistic: 'اجعلها واقعية', ai_gen_failed: 'تعذّر إنشاء الصورة. حاولي مرة أخرى.' });
...
Object.assign(RU, {
  ...
  choose_shape: 'Форма ногтя', manual_note: 'Настройте любой результат ниже — тон кожи, подтон, структуру и форму ногтя.', manual_fix: 'Анализ неверен? Исправить', result_undertone: 'Подтон', result_hand: 'Рука',
...
Object.assign(AR, {
  ...
  choose_shape: 'شكل الظفر', manual_note: 'يمكنك ضبط أي نتيجة أدناه — لون البشرة، درجة اللون، بنية وشكل الظفر.', manual_fix: 'التحليل خاطئ؟ صحّحي', result_undertone: 'درجة اللون', result_hand: 'اليد',
