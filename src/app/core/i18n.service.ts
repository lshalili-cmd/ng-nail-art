...
// ── AR Deneme ──
Object.assign(EN, { ar_title: 'AR Try-On', ar_capture: 'Capture', ar_color: 'Polish color', ar_close: 'Close', ar_hint: 'Show your hand to the camera', ar_starting: 'Starting camera...', ar_need_credit: 'AR try-on used up. Generate a new nail design to try it on.' });
Object.assign(TR, { ar_title: 'AR Deneme', ar_capture: 'Fotoğraf', ar_color: 'Oje rengi', ar_close: 'Kapat', ar_hint: 'Elinizi kameraya gösterin', ar_starting: 'Kamera başlatılıyor...', ar_need_credit: 'AR deneme hakkın kullanıldı. Denemek için yeni bir tasarım üret.' });
Object.assign(RU, { ar_title: 'AR примерка', ar_capture: 'Снимок', ar_color: 'Цвет лака', ar_close: 'Закрыть', ar_hint: 'Покажите руку камере', ar_starting: 'Запуск камеры...', ar_need_credit: 'AR-примерка использована. Создайте новый дизайн, чтобы примерить.' });
Object.assign(AR, { ar_title: 'تجربة AR', ar_capture: 'التقاط', ar_color: 'لون الطلاء', ar_close: 'إغلاق', ar_hint: 'أظهري يدك للكاميرا', ar_starting: 'جارٍ تشغيل الكاميرا...', ar_need_credit: 'انتهت تجربة AR. أنشئي تصميمًا جديدًا للتجربة.' });
